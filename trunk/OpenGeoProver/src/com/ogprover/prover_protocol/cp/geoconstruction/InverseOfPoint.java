...
public class InverseOfPoint extends SelfConditionalPoint {
	...
	public InverseOfPoint(String pointLabel, Point A, Circle invC) {
		...
		// deals with construction protocol
	}
	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexA < 0 || indexC < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Inverse point " + this.getGeoObjectLabel() + " can't be constructed since original point or circle of inversion are not added to construction protocol");
