...
* <dd>Class for GeoGebra's command used for construction of random point 
*     from some geometric object</dd>
* </dl>
* 
* @version 1.00
* @author Ivan Petrovic
*/
public class PointCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_POINT;
	 ...
	 */
	public PointCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
