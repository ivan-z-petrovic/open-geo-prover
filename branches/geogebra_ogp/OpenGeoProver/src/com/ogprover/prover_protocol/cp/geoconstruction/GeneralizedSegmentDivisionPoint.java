...
public class GeneralizedSegmentDivisionPoint extends SelfConditionalPoint {
	 ...
	 * 
	 * @see com.ogprover.prover_protocol.cp.geoconstruction.SelfConditionalPoint#instantiateXCondition(java.util.Map)
	 */
	@Override
	 ...
	 * 
	 * @see com.ogprover.prover_protocol.cp.geoconstruction.SelfConditionalPoint#instantiateYCondition(java.util.Map)
	 */
	@Override
	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexA < 0 || indexB < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Segment division point " + this.getGeoObjectLabel() + " can't be constructed since some of segment's end ponts is not added to construction protocol");
