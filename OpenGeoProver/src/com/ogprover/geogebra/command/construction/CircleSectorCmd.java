...
* <dd>Class for GeoGebra's command used for construction of circle sector. 
* </dd>
* </dl>
* 
* @version 1.00
...
*/
public class CircleSectorCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_CIRCLE_SECTOR;
	...
	public String getCommandName() {
		return CircleSectorCmd.cmdName;
	}
	 ...
	 */
	public CircleSectorCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
