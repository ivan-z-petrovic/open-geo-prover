	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexOP < 0 || indexC < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Central symmetric point " + this.getGeoObjectLabel() + " can't be constructed since original pont or center is not added to construction protocol");
