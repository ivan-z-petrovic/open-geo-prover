...
*/
public class OrthogonalLineCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_ORT_LINE;
	...
	public String getCommandName() {
		return OrthogonalLineCmd.cmdName;
	}
	 ...
	 */
	public OrthogonalLineCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
