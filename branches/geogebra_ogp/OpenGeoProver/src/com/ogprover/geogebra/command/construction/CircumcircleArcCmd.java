...
* <dd>Class for GeoGebra's command used for construction of circumscribed circle arc. 
* </dd>
* </dl>
* 
* @version 1.00
...
*/
public class CircumcircleArcCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_CCIRCLE_ARC;
	...
	public String getCommandName() {
		return CircumcircleArcCmd.cmdName;
	}
	 ...
	 */
	public CircumcircleArcCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
