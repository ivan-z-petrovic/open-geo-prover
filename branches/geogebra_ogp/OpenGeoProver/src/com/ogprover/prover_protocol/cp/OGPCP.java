...
package com.ogprover.prover_protocol.cp;
 ...
 * <dd>Class for construction protocol - collection of 
...
public class OGPCP {
	...
	/**
	 * Method for adding one construction step to this construction protocol at the end
	 * 
	 * @param gc	Geometry construction to add into this protocol
	 */
	public void addGeoConstruction(GeoConstruction gc) {
		if (gc == null) {
			OpenGeoProver.settings.getLogger().warn("Attempt to add null object to construction protocol");
	...
	/**
	 * Method for adding one construction step to this construction protocol 
	 * at the specified position
	 * 
	 * @param index	Index in construction protocol where to put new construction
	 * @param gc	Geometry construction to add into this protocol
	 */
	public void addGeoConstruction(int index, GeoConstruction gc) {
		...
		if (index < 0 || index > this.getConstructionSteps().size()) {
			logger.error("Bad index to put object in construction protocol - index out of boundaries");
			return;
		}
	...
	public void addThmStatement(ThmStatement statement) {
		if (statement == null) {
			OpenGeoProver.settings.getLogger().error("Attempt to add null theorem statement to construction protocol.");
			return;
		}
	...
	/**
	 * Method to add NDG condition to construction protocol.
	 * 
	 * @param ndgCond	NDG condition to add to this construction protocol.
	 */
	public void addNDGCondition(NDGCondition ndgCond) {
		if (ndgCond == null) {
			OpenGeoProver.settings.getLogger().error("Attempt to add null NDG condition to construction protocol.");
			return;
		}
	...
	/**
	 * Method that checks the validity of this construction protocol.
