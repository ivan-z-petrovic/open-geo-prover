...
public class Segment implements GeneralizedSegment, PointList {
	...
	public XPolynomial getInstantiatedConditionForSquareOfSegment() {
		...
		return OGPCP.instantiateCondition(Segment.squareOfDistance, pointsMap); // do not call reduction by UTerm division here
	}
	...
	public XPolynomial getInstantiatedXCoordinateOfOrientedSegment() {
		...
		return OGPCP.instantiateCondition(Segment.xCoordOfOrientedSeg, pointsMap); // do not call reduction by UTerm division here
	}
	...
	public XPolynomial getInstantiatedYCoordinateOfOrientedSegment() {
		...
		return OGPCP.instantiateCondition(Segment.yCoordOfOrientedSeg, pointsMap); // do not call reduction by UTerm division here
	}
