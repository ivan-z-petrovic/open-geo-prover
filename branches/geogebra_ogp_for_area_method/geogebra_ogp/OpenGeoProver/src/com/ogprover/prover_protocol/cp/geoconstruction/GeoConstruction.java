...
public abstract class GeoConstruction implements GeoObject {
	...
	/**
	 * Construction protocol that contains this construction
	 */
	...
	/**
	 * Method that sets construction protocol that contains this construction
	 * 
	 * @param consProtocol The construction protocol to set
	 */
	...
	/**
	 * Method that sets the index of this object in construction protocol
	 * 
	 ...
	 * its construction protocol.
	 * 
	 * @return	True if step is valid, false otherwise
	 */
	public boolean isValidConstructionStep() {
		// This base method will only check if object is 
		// assigned to construction protocol; there will be
		// only one mapping in construction protocol for the
		...
		try {
			if (this.consProtocol == null) {
				...
				output.closeItemWithDesc("Object " + this.geoObjectLabel + " not assigned to construction protocol.");
				return false; // object not assigned to any construction protocol
			}
