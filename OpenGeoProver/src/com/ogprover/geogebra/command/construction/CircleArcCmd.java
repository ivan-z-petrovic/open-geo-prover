...
* <dd>Class for GeoGebra's command used for construction of circle arc. 
* </dd>
* </dl>
* 
* @version 1.00
...
*/
public class CircleArcCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_CIRCLE_ARC;
	 ...
	 */
	public CircleArcCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
