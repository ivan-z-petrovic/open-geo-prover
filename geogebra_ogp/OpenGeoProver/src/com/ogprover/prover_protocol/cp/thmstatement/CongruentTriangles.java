...
public class CongruentTriangles extends DimensionThmStatement {
	...
	public XPolynomial getAlgebraicForm() {
		...
		XPolynomial x1 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(B1Label, C1Label), pointsMap);
		XPolynomial y1 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(C1Label, A1Label), pointsMap);
		XPolynomial z1 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(A1Label, B1Label), pointsMap);
		XPolynomial x2 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(B2Label, C2Label), pointsMap);
		XPolynomial y2 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(C2Label, A2Label), pointsMap);
		XPolynomial z2 = OGPCP.instantiateCondition(Segment.getSubstitutedConditionForSquareOfDistance(A2Label, B2Label), pointsMap);
