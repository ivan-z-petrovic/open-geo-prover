...
public class AMPratioPoint extends AMPoint {
	 ...
	 * @param r			Ratio
	 */
	public AMPratioPoint(String label,AMPoint w,AMPoint u, AMPoint v, AMRatio r) {
		type = 2;
		this.label = label;
		this.w = w;
		this.u = u;
	 ...
	 * @param r		Ratio
	 */
	public AMPratioPoint(AMPoint w,AMPoint u, AMPoint v, AMRatio r) {
		type = 2;
