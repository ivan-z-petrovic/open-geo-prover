	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexOP < 0 || indexC < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Rotated point " + this.getGeoObjectLabel() + " can't be constructed since original point or center of rotation are not added to construction protocol");
