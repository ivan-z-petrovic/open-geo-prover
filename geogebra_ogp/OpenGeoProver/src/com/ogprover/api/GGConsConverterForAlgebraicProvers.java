...
public class GGConsConverterForAlgebraicProvers extends GeoGebraConstructionConverter {
	 ...
	 */
	public GGConsConverterForAlgebraicProvers(Vector<GeoGebraCommand> inputCmdList, OGPCP ogpCP) {
	...
	/**
	 * @see com.ogprover.api.GeoGebraConstructionConverter#convertAngleCmd(com.ogprover.prover_protocol.cp.geogebra.GeoGebraCommand)
	 */
	protected GeoConstruction convertAngleCmd(GeoGebraCommand ggCmd) {
		/*
	...
	/**
	 * @see com.ogprover.api.GeoGebraConstructionConverter#convertPolygonCmd(com.ogprover.prover_protocol.cp.geogebra.GeoGebraCommand)
	 */
	protected GeoConstruction convertPolygonCmd(GeoGebraCommand ggCmd) {
		/*
	...
	/**
	 * @see com.ogprover.api.GeoGebraConstructionConverter#convertPolyLineCmd(com.ogprover.prover_protocol.cp.geogebra.GeoGebraCommand)
	 */
	protected GeoConstruction convertPolyLineCmd(GeoGebraCommand ggCmd) {
		/*
