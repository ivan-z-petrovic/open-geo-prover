	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (baseCircle.getIndex() < 0 || baseCircle.getIndex() >= this.index) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Random point " + this.getGeoObjectLabel() + " can't be constructed since its base circle is not yet constructed or not added to theorem protocol");
				return false;
			}
		} catch (IOException e) {
