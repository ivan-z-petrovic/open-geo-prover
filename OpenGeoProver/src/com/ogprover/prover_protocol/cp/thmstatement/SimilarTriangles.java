...
public class SimilarTriangles extends DimensionThmStatement {
	...
	public XPolynomial getAlgebraicForm() {
		...
		if (this.trianglesOfSameOrientation)
			return OGPCP.instantiateCondition(conditionForSimilarTrianglesWithSameOrientation, pointsMap);
		return OGPCP.instantiateCondition(conditionForSimilarTrianglesWithOppositeOrientation, pointsMap);
	}
