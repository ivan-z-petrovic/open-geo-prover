...
* <dd>Class for random point from line</dd>
* </dl>
* 
* @version 1.00
...
public class RandomPointFromLine extends RandomPointFromSetOfPoints {
	 ...
	 * @param line			Base line which this point belongs to
	 */
	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (baseLine.getIndex() < 0 || baseLine.getIndex() >= this.index) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Random point " + this.getGeoObjectLabel() + " can't be constructed since its base line is not yet constructed or not added to construction protocol");
				return false;
			}
		} catch (IOException e) {
