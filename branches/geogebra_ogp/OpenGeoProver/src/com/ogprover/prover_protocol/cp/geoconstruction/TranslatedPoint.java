	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexA < 0 || indexB < 0 || indexOP < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Translated point " + this.getGeoObjectLabel() + " can't be constructed since some of vector's points or original point is not added to construction protocol");
