...
*     interior point of specified geometry object</dd>
* </dl>
* 
* @version 1.00
* @author Ivan Petrovic
*/
public class PointInCmd extends GeoGebraCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraCommand.COMMAND_POINT_IN;
	 ...
	 */
	public PointInCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
