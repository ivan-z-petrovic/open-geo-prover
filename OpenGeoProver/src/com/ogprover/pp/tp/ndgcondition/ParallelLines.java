...
* <dd>Class for the "Those lines must be parallel" NDG condition.</dd>
* </dl>
* 
* @version 1.00
...
public class ParallelLines extends SimpleNDGCondition {
	 ...
	 */
	public ParallelLines(Point a, Point b, Point c, Point d) {
		this.a = a;
		this.b = b;
		this.c = c;
		this.d = d;
	...
	public String print() {
		return "Lines (" + a.getGeoObjectLabel() + b.getGeoObjectLabel() 
				+ ") and ("+  c.getGeoObjectLabel() + d.getGeoObjectLabel() + " must be parallel.";
	}
}