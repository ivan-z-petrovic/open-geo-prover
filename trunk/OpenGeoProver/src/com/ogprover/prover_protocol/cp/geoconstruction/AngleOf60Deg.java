...
public class AngleOf60Deg extends GeoConstruction implements SpecialConstantAngle {
     ...
     * 
     * @see com.ogprover.prover_protocol.cp.geoconstruction.SpecialConstantAngle#transformToAlgebraicForm()
     */
	public int transformToAlgebraicForm() {
		...
		try {
	    	...
	    	XPolynomial condition = OGPCP.instantiateCondition(conditionForAngleOf60Deg, pointsMap);
    ...
    /**
     * @see com.ogprover.prover_protocol.cp.geoconstruction.SpecialConstantAngle#processNDGCondition(com.ogprover.prover_protocol.cp.ndgcondition.NDGCondition)
     */
