	...
	public boolean isValidConstructionStep() {
		...
		try {
			...
			if (indexA < 0 || indexB < 0 || indexC < 0) {
				output.openItemWithDesc("Error: ");
				output.closeItemWithDesc("Harmonic conjugate point " + this.getGeoObjectLabel() + " can't be constructed since some point from triple of points is not added to construction protocol");
