...
*/
public class ConcurrentCmd extends GeoGebraStatementCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraStatementCommand.COMMAND_CONCURRENT;
	...
	*/
	public ConcurrentCmd(ArrayList<String> inputArgs, String outputArg) {
