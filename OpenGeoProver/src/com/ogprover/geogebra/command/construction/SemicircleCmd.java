...
* <dd>Class for GeoGebra's command used for construction of semicircle. 
* </dd>
* </dl>
* 
* @version 1.00
...
*/
public class SemicircleCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_SEMICIRCLE;
	 ...
	 */
	public SemicircleCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
