...
public class PointSetRelationshipManager {
	...
	public XPolynomial retrieveInstantiatedCondition() {
		 ...
		 * objects in construction protocol), for statements all constructed
		 * objects are of same importance. Therefore it would be necessary
		 * to provide mechanism to check all objects from construction 
	...
	public void processPointsAndConditionForConstruction(Map<String, Point> pointsMap) {
		...
		XPolynomial insCondition1 = OGPCP.instantiateCondition(this.condition, pointsMap).reduceByUTermDivision();
		...
		case Point.PROCESSPOLY_RETCODE_TRY_AGAIN:
			...
			XPolynomial insCondition2 = OGPCP.instantiateCondition(this.condition, pointsMap).reduceByUTermDivision();
	...
	public void processPointsAndConditionForStatement(Map<String, Point> pointsMap) {
		...
		*/
		...
		XPolynomial insCondition = OGPCP.instantiateCondition(this.condition, pointsMap);
