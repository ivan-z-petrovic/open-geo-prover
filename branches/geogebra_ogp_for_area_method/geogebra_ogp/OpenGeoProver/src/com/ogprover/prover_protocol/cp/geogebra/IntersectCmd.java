...
* <dd>Class for GeoGebra's command used for construction of intersection points</dd>
* </dl>
* 
* @version 1.00
* @author Ivan Petrovic
*/
public class IntersectCmd extends GeoGebraCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraCommand.COMMAND_INTERSECT;
	 ...
	 */
	public IntersectCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
