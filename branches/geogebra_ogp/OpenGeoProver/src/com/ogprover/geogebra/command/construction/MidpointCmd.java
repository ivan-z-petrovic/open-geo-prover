...
* <dd>Class for GeoGebra's command used for construction of midpoint</dd>
* </dl>
* 
* @version 1.00
* @author Ivan Petrovic
*/
public class MidpointCmd extends GeoGebraConstructionCommand {
	/*
	 * ======================================================================
	 * ========================== VARIABLES =================================
	 * ======================================================================
	 ...
	 */
	public static final String cmdName = GeoGebraConstructionCommand.COMMAND_MIDPOINT;
	 ...
	 */
	public MidpointCmd(ArrayList<String> inputArgs, ArrayList<String> outputArgs) {
